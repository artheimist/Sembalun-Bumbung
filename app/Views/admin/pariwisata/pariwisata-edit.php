...
<body>
	<main class="main">
		...
		<div class="content">
			...
			<form action="<?= base_url();?>/Admin/Pariwisata/Update/<?=$id['id']?>" method="POST" enctype="multipart/form-data">
				...
				<input type="text" name="deskripsi" placeholder="deskripsi singkat artikel" required title="Wajib tulis deskripsi artikel" value="<?=$id['deskripsi']?>"/>
